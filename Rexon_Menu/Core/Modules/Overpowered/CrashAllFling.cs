...
// Type: Rexon_Menu.Core.Modules.Overpowered.CrashAllFling
...
[Mod("Crash All [TARGET GRIP]", "Overpowered", "Flings all gripping players into quit box. [TARGET MUST GRIP]", false, 50, ModType.Toggle, false)]
internal class CrashAllFling : MonoBehaviour
{
	private const float ActiveSerializeTickMultiplier = 9999f;
	private const float DefaultSerializeTickMultiplier = 1000f;
	private const float FlingDistance = 3500f;
