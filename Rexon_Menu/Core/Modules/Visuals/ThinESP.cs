...
// Type: Rexon_Menu.Core.Modules.Visuals.ThinESP
...
[Mod("Thin ESP", "Visuals", "Faint thin boxes around all players.", false, 39, ModType.Toggle, false)]
internal class ThinESP : MonoBehaviour
{
	...
	private void Update()
	{
		...
		foreach (Player player in PhotonNetwork.PlayerListOthers)
		{
			...
			if (visual == null)
			{
				...
				visual.GetComponent<Renderer>().material = ShaderPatch.CreateTransparentMaterial(new Color(1f, 1f, 1f, 0.05f));
