...
// Type: Recovered.Obfuscated.GadgetSphereSmall
...
[Mod("Gadget Sphere Small", "Super Infection/Casual [MASTERCLIENT]", "Spawns small gadget sphere.", true, 24, ModType.Toggle, false)]
internal class GadgetSphereSmall : MonoBehaviour
{
	private void OnEnable()
	{
		...
		foreach (string entityName in entityNames)
		{
			if (GameNetworkUtilities.EntityTypeIdsByName.ContainsKey(entityName))
			{
				...
				{
					Vector3 entityPosition = center + Random.insideUnitSphere * 1f;
