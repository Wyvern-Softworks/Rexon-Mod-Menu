...
// Type: Recovered.Obfuscated.GadgetHollowSphereSmall
...
[Mod("Gadget Hollow Sphere Small", "Super Infection/Casual [MASTERCLIENT]", "Spawns small hollow sphere.", true, 27, ModType.Toggle, false)]
internal class GadgetHollowSphereSmall : MonoBehaviour
{
	private void OnEnable()
	{
		...
		foreach (string entityName in entityNames)
		{
			if (GameNetworkUtilities.EntityTypeIdsByName.ContainsKey(entityName))
			{
				...
				{
					Vector3 entityPosition = center + Random.onUnitSphere * 1f;
