...
// Type: Recovered.Obfuscated.GadgetSphereMedium
...
[Mod("Gadget Sphere Medium", "Super Infection/Casual [MASTERCLIENT]", "Spawns medium gadget sphere.", true, 23, ModType.Toggle, false)]
internal class GadgetSphereMedium : MonoBehaviour
{
	private void OnEnable()
	{
		...
		foreach (string entityName in entityNames)
		{
			if (GameNetworkUtilities.EntityTypeIdsByName.ContainsKey(entityName))
			{
				...
				{
					Vector3 entityPosition = center + Random.insideUnitSphere * 2f;
