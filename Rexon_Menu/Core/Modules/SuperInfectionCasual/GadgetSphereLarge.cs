...
// Type: Recovered.Obfuscated.GadgetSphereLarge
...
[Mod("Gadget Sphere Large", "Super Infection/Casual [MASTERCLIENT]", "Spawns large gadget sphere.", true, 22, ModType.Toggle, false)]
internal class GadgetSphereLarge : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		foreach (string entityName in entityNames)
		{
			if (GameNetworkUtilities.EntityTypeIdsByName.ContainsKey(entityName))
			{
				...
				{
					Vector3 entityPosition = center + Random.insideUnitSphere * 3f;
