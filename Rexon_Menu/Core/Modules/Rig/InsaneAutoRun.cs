...
// Type: Rexon_Menu.Core.Modules.Rig.InsaneAutoRun
...
[Mod("Insane Auto Run [RIGHT GRIP]", "Rig", "Fast automatic running forward.", false, 10, ModType.Toggle, false)]
internal sealed class InsaneAutoRun : MonoBehaviour
{
	private void Update()
	{
		...
		body.position = Vector3.Lerp(currentPosition, targetPosition, 0.9f);
	}
}
